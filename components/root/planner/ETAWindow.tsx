...
export default function ETAWindow({ 
  ...
  const getEmbeddedMapUrl = (directionResponse: DirectionResponse) => {
    ...
    const mode = encodeURIComponent(directionResponse.directions[0].travel_mode.toLowerCase());
        ...
        <div className='flex flex-col gap-6'>
          ...
          <div className='flex gap-4 items-center'>
            ...
            <div className='flex flex-col gap-[20px] text-sm mt-[-2px] text-customBlack-100'>
              ...
              <p>{directionResponse ? directionResponse.search_parameters.end_addr : ''}</p>
            </div>
          </div>
          ...
          <div className='flex gap-6 items-center ml-[-8px]'>
            {
              travelModes.map((mode, index) => (
                <CustomButton 
                  ...
                  className={`
                    bg-transparent text-xs border-none flex-col gap-1 items-center !p-0 !min-w-0 !h-12 !w-12
